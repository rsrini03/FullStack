...
public class AdminController {
    ...
    @Operation(summary = "Delete addon by ID", description = "Delete a addon by its ID.")
    @DeleteMapping("/addon/{id}")
    public boolean deleteAddonId(@Parameter(description = "Addon ID") @PathVariable Long id) {
